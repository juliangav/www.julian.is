...
const GlobalNav = ({ siteTitle }) => (
  <div className="site-nav-container">
    <div className="snc-header">
      <div className="sh-utility-nav">
        <div class="social-wrap">
          <a
            href="https://dribbble.com/juliangav"
            target="_blank"
          ...
          >
            <svg
              ...
              enable-background="new 0 0 17.914 17.914"
            >
              <rect
                x="0.016"
                y="0.016"
              ...
              <path
                fill="#95a4b6"
                d="M8.972,0.074c-4.912,0-8.897,3.986-8.897,8.898c0,4.917,3.985,8.899,8.897,8.899
  ...
  C16.09,12.068,14.812,14.023,12.981,15.206z"
              />
            </svg>
          </a>
          <a
            href="https://github.com/juliangav"
            target="_blank"
            rel="noopener noreferrer"
          >
            <svg
            ...
            >
              <path
                ...
                clip-rule="evenodd"
                fill="#181616"
                d="M13,0.5C5.9,0.5,0.2,6.2,0.2,13.3c0,5.7,3.7,10.5,8.8,12.2
  ...
  c0,0.3,0.2,0.7,0.9,0.6c5.1-1.7,8.8-6.5,8.8-12.2C25.8,6.2,20.1,0.5,13,0.5z"
              />
            </svg>
          </a>
          <a
          ...
          >
            ...
            >
              <path
                fill="#95a4b6"
                d="M17.841,3.447c-0.653,0.29-1.356,0.486-2.093,0.574c0.753-0.451,1.33-1.165,1.603-2.017
  ...
  c6.705,0,10.371-5.554,10.371-10.371c0-0.158-0.003-0.316-0.01-0.472C16.735,4.82,17.354,4.178,17.841,3.447z"
          ...
          <a
            href="https://www.linkedin.com/in/juliangaviria"
            target="_blank"
            rel="noopener noreferrer"
          >
            <svg
              ...
              width="17.914px"
              height="17.914px"
              viewBox="0.929 1.976 17.914 17.914"
              enable-background="new 0.929 1.976 17.914 17.914"
            >
              <g>
                <path
                  fill="#95a4b6"
                  d="M10.557,10.037v-0.028c-0.005,0.009-0.012,0.019-0.018,0.028H10.557z"
                />
                <path
                  fill="#95a4b6"
                  d="M17.462,1.966H2.309c-0.726,0-1.314,0.575-1.314,1.282v15.33c0,0.708,0.588,1.282,1.314,1.282h15.154
    ...
    <nav className="site-nav" role="navigation">
      <ul className="sn-level-1">
        <li className="sn-li-l1">
          <Link to="/about/">
            <span>About</span>
          </Link>
        </li>
